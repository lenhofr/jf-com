...
The system SHALL store accepted contact messages in an AWS DynamoDB table.
...
- **AND THEN** the system MAY also send an email notification to the campaign mailbox
