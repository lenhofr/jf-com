...
- Add an AWS-native serverless backend:
  ...
  - (Optional) email notification to the campaign mailbox
...
## Open Questions
- Delivery mechanism: store-only vs store + email notification (SES).
- Confirm required fields (see `specs/contact-form/spec.md`).
- Retention: how long should messages be retained in DynamoDB?
